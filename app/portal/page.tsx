...
export default async function EmployeePortalPage() {
  ...
  return (
    <main className="min-h-screen">
      ...
      <EmployeeTimesheet detail={detail} history={history} notifications={notifications.map((notification) => ({ ...notification, createdAt: notification.createdAt.toISOString(), readAt: notification.readAt?.toISOString() ?? null }))} />
    </main>
  );
}
