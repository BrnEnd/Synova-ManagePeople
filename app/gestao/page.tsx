    ...
    <main className="min-h-screen">
      ...
      <div className="mx-auto max-w-7xl px-5 py-8 md:px-10 md:py-12">
        ...
        <section className="mt-6 rounded-3xl border border-white/10 bg-zinc-900/65 p-6 md:p-8">
          ...
          <p className="mt-2 max-w-2xl leading-7 text-zinc-400">O cadastro de funcionários já está disponível. Clientes, contratos e alocações formarão o próximo fluxo vertical.</p>
        </section>
      </div>
    </main>
  );
