...
import { ScopeToggle } from '@/components/management/scope-toggle';
...
const allowedStatuses = ['filling', 'adjustments_requested', 'awaiting_approval', 'awaiting_invoice', 'awaiting_payment', 'paid'] as const;
const labels: Record<string, string> = { filling: 'Em preenchimento', adjustments_requested: 'Ajustes solicitados', awaiting_approval: 'Aguardando aprovação', awaiting_invoice: 'Aguardando Nota Fiscal', awaiting_payment: 'Aguardando pagamento', paid: 'Pagamento realizado', not_submitted: 'Horas não enviadas' };
