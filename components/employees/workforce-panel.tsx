...
import type { AllocationPeriod } from '@/lib/workforce/module';
...
const optionalCents = (form: FormData, key: string) => value(form, key) ? Math.round(Number(value(form, key)) * 100) : undefined;
